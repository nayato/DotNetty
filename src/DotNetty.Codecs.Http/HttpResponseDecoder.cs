...
{
    /**
         * Decodes {@link IByteBuffer}s into {@link HttpResponse}s and
         * {@link HttpContent}s.
         *
    ...
    {
        static readonly HttpResponseStatus UNKNOWN_STATUS = new HttpResponseStatus(999, "Unknown");
        ...
        protected HttpMessage createMessage(string[] initialLine)
        {
            return new DefaultHttpResponse(
                ...
                new HttpResponseStatus(int.Parse(initialLine[1]), initialLine[2]), this.validateHeaders);
        }

        // @Override
        protected HttpMessage createInvalidMessage() => new DefaultFullHttpResponse(HttpVersion.HTTP_1_0, UNKNOWN_STATUS, this.validateHeaders);

        // @Override
        protected bool isDecodingRequest() => false;
    }
}