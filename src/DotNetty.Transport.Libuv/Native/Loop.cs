        ...
        public void Close()
        {
            ...
            while (retry < 10)
            {
                try
                {
                    ...
                    Logger.Info($"Loop {loopHandle} walk all handles completed.");
                    ...
                    {
                        int busyErrorCode = RuntimeInformation.IsOSPlatform(OSPlatform.Windows) ? (int)uv_err_code.UV_EBUSY : -16; // Linux EBUSY
